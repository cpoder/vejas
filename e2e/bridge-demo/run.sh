...
SAPENV="SAP_ASHOST=${SAP_ASHOST:-localhost} SAP_SYSNR=${SAP_SYSNR:-00} SAP_CLIENT=${SAP_CLIENT:-001} SAP_USER=${SAP_USER:-DEVELOPER} SAP_PASSWD=${SAP_PASSWD:?set SAP_PASSWD} SAP_LANG=EN LD_LIBRARY_PATH=$LD"
...
export SAP_USER="${SAP_USER:-DEVELOPER}" SAP_PASSWD="${SAP_PASSWD:?set SAP_PASSWD}"
