// Admission mock for jira_issues_poll — a minimal local stand-in for the remote API.
// Usage: node mock.mjs <port>. GET /__count returns how many real calls landed.
import { createServer } from 'node:http';
const port = Number(process.argv[2] || 9200);
let count = 0;
const GET_BODY = {"issues": [{"key": "OPS-12", "fields": {"summary": "Disk pressure on node-3", "status": {"name": "In Progress"}, "updated": "2026-08-22T09:58:00.000+0000"}}], "total": 1};
