// Admission mock for workday_raas_poll — a minimal local stand-in for the remote API.
// Usage: node mock.mjs <port>. GET /__count returns how many real calls landed.
import { createServer } from 'node:http';
const port = Number(process.argv[2] || 9200);
let count = 0;
const GET_BODY = {"Report_Entry": [{"Employee_ID": "100234", "Worker": "Marie Dupont", "Hire_Date": "2024-03-01"}]};
